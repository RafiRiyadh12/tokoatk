<%-- 
    Document   : formbarangtambah.view
    Created on : Jun 16, 2025, 8:18:32 PM
    ...
    <style>
        * {
        ...
        @media (max-width: 480px) {
            ...
            h2 { font-size: 20px; }
            input[type="text"], input[type="number"] { font-size: 13px; padding: 8px; }
            .button-group { flex-direction: column; }
            button, .back-link { margin: 5px 0; width: 100%; }
        }
...
<body>
    ...
    <div id="successPopup" class="success-popup">
        ...
        <div class="success-message" id="successMessage">Barang berhasil ditambahkan.</div>
    </div>
    ...
    <script>
        ...
        function showSuccessPopup(message) {
            ...
            setTimeout(() => {
                ...
                window.location.href = "baranglist.jsp"; // Redirect setelah popup hilang
            }, 3000);
        }
    </script>
</body>
